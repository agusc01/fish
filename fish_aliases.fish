...
alias wifiinterface='iw dev | grep -i interface | xargs | cut -d " " -f 2'
alias wifiscan='sudo ip link set wlo1 up && sudo iwlist wlo1 scan | grep SSID | cut -d: -f2 | tr -d " \"" | sort | uniq'

alias wifioff='sudo ifdown $(wifiinterface) && refreshdbar'
alias wifion='sudo ifup $(wifiinterface) && refreshdbar'
alias wifireset='sudo ifdown $(wifiinterface) && sudo ifup $(wifiinterface) && refreshdbar'
